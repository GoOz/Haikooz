...
{% image "./img/itineraire.png", "Carte de l'itinéraire" %}
...
{% image "./img/DSCF0585.jpg", "Vue sur un parc de New Town avec des monuments au fond" %}
...
{% image "./img/DSCF0568.jpg", "Vue sur une rue perpendiculaire passant au-dessus" %}
...
{% image "./img/DSCF0573.jpg", "Enseigne du White Hart Inn" %}

#### Victoria Street
De **Grassmarket** on a remonté **Victoria Street**, rue qui aurait inspiré **[J. K. Rowling](https://fr.wikipedia.org/wiki/J._K._Rowling)** pour [Diagon Alley](https://fr.wikipedia.org/wiki/Chemin_de_Traverse_(Harry_Potter)) (et c'est vrai qu'il y a un petit truc, il y a même des magasins de pop culture qui vendent, évidemment, du *merchandising* Harry Potter). C'est une rue en pente, qui rejoint directement The Royal Mile, la rue la plus importante d'Edinburgh.

{% image "./img/DSCF0632.jpg", "Victoria Street" %}
...
{% image "./img/DSCF0595.jpg", "Cimetière de GreyFriars Kirk" %}
...
{% image "./img/DSCF0643.jpg", "Salle de lecture de la bibliothèque jeunesse" %}
...
{% image "./img/DSCF0576.jpg", "Église de la Royal Mile" %}
...
{% image "./img/23-09-12 16-16-01 3207.jpg", "Tea time à l'écossaise" %}
...
{% image "./img/DSCF0667.jpg", "Edinburgh et Arthur's seat de nuit" %}
...
{% image "./img/23-09-12 20-58-19 3216.jpg", "Dernier verre dans le Banshee labyrinth" %}
...
### Scottish breakfast
Je ne suis pas du matin et mon estomac non plus mais j'ai quand même essayé un *scottish breakfast* (ce qui est comme un *british breakfast* - beans, sausage, bacon - mais avec des trucs scots avec en prime comme du haggis, du boudin noir et des potato scones).
C'était gras et lourd, en tout cas pour moi, mais c'était bon. Faut juste être prêt à digérer tout ça.

{% image "./img/23-09-13 09-25-23 3218.jpg", "Petit déjeuner à l'écossaise" %}
...
{% image "./img/DSCF0707.jpg", "Entrée du Surgeons' Hall Museums" %}
...
{% image "./img/DSCF0641.jpg", "National Library of Scotland" %}
...
{% image "./img/23-09-13 19-19-32 3222.jpg", "National Library of Scotland" %}
...
{% image "./img/DSCF0720.jpg", "Cimetière de Stirling" %}
...
{% image "./img/DSCF0725.jpg", "La Lost Valley" %}
...
{% image "./img/23-09-14 19-54-31 3232.jpg", "Mon Repas au Old station" %}
...
{% image "./img/DSCF0782.jpg", "Vallée de Glen Nevis" %}
...
{% image "./img/DSCF0835.jpg", "Vue depuis les hauteurs du Glencoe Mountain Resort" %}
...
{% image "./img/DSCF0872.jpg", "Carte de l'itinéraire" %}
...
{% image "./img/DSCF0963.jpg", "Les Fairy pools" %}
...
{% image "./img/DSCF1002.jpg", "Château de Dunvegan" %}
...
{% image "./img/DSCF1077.jpg", "Le port de Portree" %}
...
{% image "./img/DSCF1113.jpg", "Les Fairy Glen" %}
...
{% image "./img/DSCF1239.jpg", "Old man of Storr" %}
...
{% image "./img/DSCF1271.jpg", "Château Eilean Donan" %}
...
{% image "./img/DSCF1276.jpg", "Clava cairn" %}
...
{% image "./img/23-09-17 17-50-01 3265.jpg", "Champ de bataille de Culloden" %}
...
{% image "./img/23-09-18 10-50-53 3270.jpg", "Abbaye de Pluscarden" %}
...
{% image "./img/DSCF1324.jpg", "Rocher de Whale's mouth" %}
...
{% image "./img/DSCF1356.jpg", "Cairn du prince Albert." %}
...
{% image "./img/23-09-19 18-43-51 3287.jpg", "Notre soirée apéro avec du vin, de la bière et des chips." %}
...
{% image "./img/DSCF1454.jpg", "St Bridget's kirk" %}
