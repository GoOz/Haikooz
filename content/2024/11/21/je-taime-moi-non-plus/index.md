...
{% image "./img/urbex.jpeg", "Photographie exemple d'urbex" %}
...
{% image "./img/macro.jpg", "Photographie exemple de macro" %}
...
{% image "./img/nude1.jpeg", "Photographie exemple de nu" %}
...
{% image "./img/sport.jpg", "Photographie exemple de sport" %}
...
{% image "./img/docu.jpg", "Photographie exemple de documentaire" %}
...
{% image "./img/mode.jpg", "Photographie exemple de mode" %}
...
{% image "./img/double.jpg", "Photographie exemple de double exposition" %}
...
{% image "./img/diptyque.jpg", "Photographie exemple de diptyque" %}
...
{% image "./img/sooc.jpg", "Photographie exemple de SOOC" %}
...
{% image "./img/lightpainting.jpg", "Photographie exemple de light painting" %}
...
{% image "./img/nature.jpeg", "Photographie exemple de nature" %}
...
{% image "./img/paysage.jpeg", "Photographie exemple de paysage" %}
...
{% image "./img/portrait.jpeg", "Photographie exemple de portrait" %}
...
{% image "./img/street.jpeg", "Photographie exemple de street" %}
...
{% image "./img/abstrait.jpeg", "Photographie exemple de abstrait" %}
...
{% image "./img/minimalisme.jpeg", "Photographie exemple de minimalisme" %}
...
{% image "./img/nude2.jpg", "Photographie exemple de nu" %}
...
{% image "./img/lines.jpeg", "Photographie exemple de lignes et de forme" %}
...
{% image "./img/architecture.jpeg", "Photographie exemple d'architecture'" %}
...
{% image "./img/aerien.jpg", "Photographie exemple d'aérien" %}
...
{% image "./img/self.jpeg", "Photographie exemple d'auto-portrait" %}
...
{% image "./img/still.jpg", "Photographie exemple de nature morte" %}
